...
// Replace the below line with the equation obtained from nonlinear regression analysis
  return (1183 + (-6.31 * a_value) + (0.0122 * a_value * a_value) + (-8.21 * pow(10, -6) * a_value * a_value * a_value));(1183 + (-6.31 * a_value) + (0.0122 * a_value * a_value) + (-8.21 * pow(10, -6) * a_value * a_value * a_value));
}
